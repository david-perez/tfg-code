...
SELECT COUNT(DISTINCT subject_id) FROM training_set_top10_labels_patients_and_diagnoses;
...
SELECT COUNT(DISTINCT subject_id) FROM test_set_top10_labels_patients_and_diagnoses;
